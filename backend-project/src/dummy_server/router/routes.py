...
def add_routes(app):
    ...
    api.add_resource(res.explainability.GetSHAPValuesTeam, API + "xai/teams/<int:team_id_home>-<int:team_id_away>")
    ...
    api.add_resource(res.explainability.GetSHAPValuesBoxscore, API + "xai/<float:AST_home>-<float:BLK_home>-<float:DREB_home>-<float:FG3A_home>-<float:FG3M_home>-<float:FGA_home>-<float:FGM_home>-<float:FTA_home>-<float:FTM_home>-<float:OREB_home>-<float:PF_home>-<float:STL_home>-<float:TO_home>_<float:AST_away>-<float:BLK_away>-<float:DREB_away>-<float:FG3A_away>-<float:FG3M_away>-<float:FGA_away>-<float:FGM_away>-<float:FTA_away>-<float:FTM_away>-<float:OREB_away>-<float:PF_away>-<float:STL_away>-<float:TO_away>")
